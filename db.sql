...
CREATE TABLE IF NOT EXISTS `unibook`.`professor_course` (
  ...
  INDEX `fk_course_idx` (`course` ASC),
...
CREATE TABLE IF NOT EXISTS `unibook`.`book` (
  ...
  INDEX `fk_book_course1_idx` (`course` ASC),
...
CREATE TABLE IF NOT EXISTS `unibook`.`sellable_book` (
  ...
  PRIMARY KEY (`code`),
  INDEX `fk_sellable_book_account1_idx` (`seller` ASC),
  INDEX `fk_sellable_book_account2_idx` (`buyer` ASC),
  INDEX `fk_sellable_book_book1_idx` (`course` ASC, `isbn` ASC),
...
CREATE TABLE IF NOT EXISTS `unibook`.`negotiation` (
  ...
  INDEX `fk_negotiation_account1_idx` (`student` ASC),
